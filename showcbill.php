...
<title>SHOW CUSTOMER BILL</title>
...
$result3 = mysqli_query($con,"select cno,cname from customer ");
...
//if(isset($_GET['viewcust']))
	//{
	$result5 = mysqli_query($con,"select cno,cname from customer ");
...
<td><a href="bill_customer.php?del_farm=<?php echo $cno; ?>">Generate Bill</a></td>
</tr>
